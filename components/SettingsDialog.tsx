...
function IntensityOption({
  ...
  value: UiSettings["animationIntensity"];
  label: string;
  active: boolean;
  onClick: () => void;
}) {
      ...
      >
        ...
        <div style={{ padding: "4px 16px 14px", overflowY: "auto" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <IntensityOption value="smooth" label={t("settings.intensitySmooth")} active={settings.animationIntensity === "smooth"} onClick={() => update({ animationIntensity: "smooth" })} />
            <IntensityOption value="standard" label={t("settings.intensityStandard")} active={settings.animationIntensity === "standard"} onClick={() => update({ animationIntensity: "standard" })} />
            <IntensityOption value="none" label={t("settings.intensityNone")} active={settings.animationIntensity === "none"} onClick={() => update({ animationIntensity: "none" })} />
          </div>
