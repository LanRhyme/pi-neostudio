...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.autoScrollDesc": "Follow the latest output while streaming; reading history does not interrupt",
    "settings.charAnimation": "Character animation",
    "settings.charAnimationDesc": "Characters fade and slide up while streaming",
    "settings.thinkingAutoExpand": "Auto-expand thinking",
    "settings.thinkingAutoExpandDesc": "Expand thinking while streaming, collapse when finished",
