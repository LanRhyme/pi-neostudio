...
export const enLocale: LocalePlugin = {
	...
	messages: {
		...
		"sidebar.activeWorkspaces": "ACTIVE WORKSPACES",
		"sidebar.noWorkspacesFound": "No workspaces found.",
		"sidebar.openFolderAction": "Open Folder...",
		"sidebar.openDefaultAction": "Open Default Workspace",
		"sidebar.searchPlaceholder": "Search sessions & messages...",
		"sidebar.searchResults": "Search Results",
		"sidebar.noSearchResults": "No matching sessions or messages",
		"sidebar.removeProject": "Remove workspace from list",
		"sidebar.pinProject": "Pin workspace",
		"sidebar.unpinProject": "Unpin workspace",
		"sidebar.manageWorkspaces": "Manage Workspaces...",
		"sidebar.hiddenWorkspaces": "Hidden Workspaces",
		"sidebar.restoreWorkspace": "Restore",
		...
		"i18n.taskFinished": "The task has finished running.",
		...
		"i18n.showSummary": "Show summary",
		"i18n.hideSummary": "Hide summary",
		"i18n.thinkingUnavailable": "Thinking content unavailable",
		"settings.title": "Settings",
		"settings.close": "Close",
		"settings.streaming": "Streaming",
		"settings.autoScroll": "Auto-scroll",
		"settings.autoScrollDesc":
			"Follow the latest output while streaming; reading history does not interrupt",
		"settings.charAnimation": "Character animation",
		"settings.charAnimationDesc":
			"Characters fade and slide up while streaming",
		"settings.thinkingAutoExpand": "Auto-expand thinking",
		"settings.thinkingAutoExpandDesc":
			"Expand thinking while streaming, collapse when finished",
		"settings.animationIntensity": "Animation intensity",
		"settings.intensitySmooth": "Smooth",
		"settings.intensityStandard": "Standard",
		"settings.intensityNone": "Off",
		...
		"settings.fontSizeComfortable": "Comfortable",
		"settings.notifications": "Notifications",
		"settings.completionSound": "Completion sound",
		"settings.completionSoundDesc": "Play a sound when the agent finishes",
		"settings.desktopNotifications": "Desktop notifications",
		"settings.desktopNotificationsDesc":
			"Show a system notification when the agent finishes while the window is hidden",
		"settings.notificationsDenied":
			"Notification permission was denied in the browser; allow it in site settings",
		"settings.notificationsPrompt":
			"Enabling will request browser notification permission",
		"notification.done": "Task complete",
		"notification.body": 'Session "{title}" finished',
		"notification.finished": "The session has finished",
		"usage.loading": "Loading usage…",
		"usage.today": "Today",
		"usage.last7": "7 days",
		"usage.last30": "30 days",
		"usage.allTime": "All time",
		"usage.dailyUsage": "Daily tokens",
		"usage.less": "Less",
		"usage.more": "More",
		"usage.calls": "calls",
		"usage.sessionDetail": "Session detail",
		"usage.noData": "No usage recorded yet",
		"usage.modelBreakdown": "By model",
		"usage.refresh": "Refresh",
		"usage.rescan": "Re-scan",
		"usage.rescanning": "Scanning…",
		"usage.records": "{count} records",
		"usage.sessionFiles": "{count} session files scanned",
		"i18n.before": "Before",
		"i18n.after": "After",
		...
		"git.aiCommit": "AI commit message generation",
		"git.aiModel": "Model",
		"git.aiModelDesc":
		...
		"git.aiPromptPlaceholder":
			"Generate a concise, conventional git commit message based on the following git diff. Output ONLY the commit message itself, without markdown blocks, explanations, or quotes.\n\nDiff:\n{diff}",
		"git.aiPromptReset": "Reset to default",
		"settings.tabGit": "Git",
		"git.aiModelLoadError": "Failed to load model list; using default model",
		"git.generatedBy": "Generated with",
	},
};
