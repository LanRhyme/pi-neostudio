...
export const zhCNLocale: LocalePlugin = {
	...
	messages: {
		...
		"sidebar.activeWorkspaces": "活跃工作区",
		"sidebar.noWorkspacesFound": "没有找到工作区",
		"sidebar.openFolderAction": "打开其他文件夹...",
		"sidebar.openDefaultAction": "打开默认临时工作区",
		"sidebar.searchPlaceholder": "搜索会话及聊天内容...",
		"sidebar.searchResults": "搜索结果",
		"sidebar.noSearchResults": "未找到匹配的会话或消息",
		"sidebar.removeProject": "从列表中移除工作区",
		"sidebar.pinProject": "置顶工作区",
		"sidebar.unpinProject": "取消置顶",
		"sidebar.manageWorkspaces": "管理工作区...",
		"sidebar.hiddenWorkspaces": "已隐藏的工作区",
		"sidebar.restoreWorkspace": "恢复",
		...
		"i18n.close": "关闭",
		"i18n.sessionComplete": "会话完成",
		"i18n.taskFinished": "任务已运行完成。",
		...
		"i18n.showSummary": "显示摘要",
		"i18n.hideSummary": "收起摘要",
		"i18n.thinkingUnavailable": "思考内容不可用",
		"settings.title": "设置",
		"settings.close": "关闭",
		"settings.streaming": "流式输出",
		"settings.autoScroll": "自动滚动跟随",
		"settings.autoScrollDesc":
			"流式输出时自动滚到最新内容，向上浏览历史时不打断",
		"settings.charAnimation": "逐字动画",
		"settings.charAnimationDesc": "流式输出时文字逐字渐显上滑",
		"settings.thinkingAutoExpand": "思考自动展开",
		"settings.thinkingAutoExpandDesc": "思考时自动展开内容，结束后自动收起",
		"settings.animationIntensity": "动画强度",
		"settings.intensitySmooth": "柔和",
		"settings.intensityStandard": "标准",
		"settings.intensityNone": "关闭",
		"settings.reset": "恢复默认",
		...
		"settings.accent": "主题色",
		"settings.accentCustom": "自定义颜色",
		"settings.fontSize": "字体大小",
		"settings.fontSizeCompact": "紧凑",
		"settings.fontSizeNormal": "标准",
		"settings.fontSizeComfortable": "舒适",
		"settings.notifications": "通知",
		"settings.completionSound": "完成提示音",
		"settings.completionSoundDesc": "任务完成时播放提示音",
		"settings.desktopNotifications": "桌面通知",
		"settings.desktopNotificationsDesc": "窗口不在前台时，任务完成弹出系统通知",
		"settings.notificationsDenied":
			"通知权限已被浏览器拒绝，可在浏览器站点设置中允许",
		"settings.notificationsPrompt": "开启后将请求浏览器通知权限",
		"notification.done": "任务完成",
		"notification.body": "会话「{title}」已完成",
		"notification.finished": "会话已完成",
		"usage.loading": "正在加载用量…",
		"usage.today": "今日",
		"usage.last7": "近 7 天",
		"usage.last30": "近 30 天",
		"usage.allTime": "累计",
		"usage.dailyUsage": "每日 Token 用量",
		"usage.less": "少",
		"usage.more": "多",
		"usage.calls": "次",
		"usage.sessionDetail": "会话明细",
		"usage.noData": "暂无用量记录",
		"usage.modelBreakdown": "按模型",
		"usage.refresh": "刷新",
		"usage.rescan": "重新扫描",
		"usage.rescanning": "扫描中…",
		"usage.records": "已记录 {count} 条",
		"usage.sessionFiles": "已扫描 {count} 个会话文件",
		"i18n.before": "之前",
		"i18n.after": "之后",
		...
		"git.aiPromptPlaceholder":
			"根据以下 git diff 生成一条简洁的 conventional commit 提交信息……\n\nDiff:\n{diff}",
		"git.aiPromptReset": "恢复默认",
		"settings.tabGit": "Git",
		"git.aiModelLoadError": "模型列表加载失败，将使用默认模型",
		"git.generatedBy": "已用模型",
	},
};
